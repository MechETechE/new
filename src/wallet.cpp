...
// gilly: total coins staked (non-spendable until maturity)
...
// gilly: check 'spent' consistency between wallet and txindex
// gilly: fix wallet spent state according to txindex
...
// gilly: disable transaction (only for coinstake)
